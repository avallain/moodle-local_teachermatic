...
/**
 * Failed to create shortanswer question event
 *
 * @package   local_teachermatic
 * @copyright 2024, Teachermatic <teachermatic.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class create_shortanswer_failed extends base
{
    /**
     * Initialize event
     *
    ...
    public static function get_name() {
        return get_string(
            "error:event:createshortanswerfailed",
            "local_teachermatic",
        );
    }
    ...
    public function get_description() {
        ...
        $description = get_string(
            "error:event:createshortanswerfaileddescription",
            "local_teachermatic",
            [
                "userid" => $this->userid,
