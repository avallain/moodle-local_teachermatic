...
/**
 * Failed to create coursemodresource question event
 *
 * @package   local_teachermatic
 * @copyright 2024, Teachermatic <teachermatic.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class create_course_mod_resource_failed extends base
{
    /**
     * Initialize event
     *
    ...
    public static function get_name() {
        return get_string(
            "error:event:createcoursemodresourcefailed",
            "local_teachermatic",
        );
    }
    ...
    public function get_description() {
        ...
        $description = get_string(
            "error:event:createcoursemodresourcefaileddescription",
            "local_teachermatic",
            [
                "userid" => $this->userid,
