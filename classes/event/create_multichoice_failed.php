...
/**
 * Failed to create multichoice question event
 *
 * @package   local_teachermatic
 * @copyright 2024, Teachermatic <teachermatic.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class create_multichoice_failed extends base
{
    /**
     * Initialize event
     *
    ...
    public static function get_name() {
        return get_string(
            "error:event:createmultichoicefailed",
            "local_teachermatic",
        );
    }
    ...
    public function get_description() {
        ...
        $description = get_string(
            "error:event:createmultichoicefaileddescription",
            "local_teachermatic",
            [
                "userid" => $this->userid,
